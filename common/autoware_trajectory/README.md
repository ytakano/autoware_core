...
| <ul><li>`compute_lateral_distance`</li></ul>                                                                                          | A utility A utility function that computes the normal distance between a given `target point` and the tangent line of the pose at specified arc-length `s` on the trajectory.<br> See below cell figure                                                                                                                                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                                                                               |
