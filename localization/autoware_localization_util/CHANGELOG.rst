...
* chore(`autoware_localization_util`): minor refactoring for header wrap (`#874 <https://github.com/mitsudome-r/autoware_core/issues/874>`_)
  * chore: use `<>` for public header wrap
  * fix: apply `pre-commit`
  ---------
* Contributors: Junya Sasaki, Vishal Chauhan, github-actions
